...
model = LlamaForCausalLM.from_pretrained('llama-small')
...
model.save_pretrained("fine_tuned_model_llama")
tokenizer.save_pretrained("fine_tuned_model_llama")

# Load the fine-tuned model for inference
tokenizer = LlamaTokenizer.from_pretrained("fine_tuned_model_llama")
model = LlamaForCausalLM.from_pretrained("fine_tuned_model_llama")
